# Generated by Django 2.1 on 2019-01-09 08:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_name', models.CharField(choices=[('HPDViolation', 'HPDViolation'), ('Property', 'Property'), ('Council', 'Council'), ('AcrisRealMasterLegal', 'AcrisRealMasterLegal'), ('AcrisRealParty', 'AcrisRealParty'), ('HPDComplaint', 'HPDComplaint'), ('DOBViolation', 'DOBViolation'), ('ECBViolation', 'ECBViolation'), ('DOBComplaint', 'DOBComplaint')], max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('model_name', models.CharField(choices=[('HPDViolation', 'HPDViolation'), ('Property', 'Property'), ('Council', 'Council'), ('AcrisRealMasterLegal', 'AcrisRealMasterLegal'), ('AcrisRealParty', 'AcrisRealParty'), ('HPDComplaint', 'HPDComplaint'), ('DOBViolation', 'DOBViolation'), ('ECBViolation', 'ECBViolation'), ('DOBComplaint', 'DOBComplaint')], max_length=255)),

...
docker-compose -f docker-compose.yml -f docker-compose.prod.yml up -d postgres app celery_update celery_default flower nginx certbot --force-recreate --build --remove-orphans

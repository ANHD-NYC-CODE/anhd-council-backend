...
class AdvancedPropertyFilter(django_filters.rest_framework.FilterSet):
    ...
    def filter_advancedquery(self, queryset, name, values):
        ...
        queryset = queryset.defer("ct2010",
            ...
            "propertyannotation__lispendens_last30",
            "propertyannotation__lispendens_lastyear",
            "propertyannotation__lispendens_last3years",
            "propertyannotation__lispendens_lastupdated",

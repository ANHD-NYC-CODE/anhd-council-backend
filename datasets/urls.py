...
properties_router.register(
    'dobpermitsissued',
    v.dobpermitsissued_view.DOBPermitIssuedJoinedViewSet,
    base_name='property-dobpermitsissued',
    parents_query_lookups=['bbl']
)
...
buildings_router.register(
    'dobpermitsissued',
    v.dobpermitsissued_view.DOBPermitIssuedJoinedViewSet,
    base_name='building-dobpermitsissued',
    parents_query_lookups=['bin']
)
...
router.register(r'dobpermitsissued', v.dobpermitsissued_view.DOBPermitIssuedJoinedViewSet)

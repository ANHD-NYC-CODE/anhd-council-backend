# Generated by Django 2.1 on 2019-01-09 02:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lhnd', models.TextField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='hpdviolation',
            name='buildingid',
            field=models.ForeignKey(blank=True, db_column='buildingid', db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.Building'),
        ),
        migrations.AddField(

# Generated by Django 2.1.5 on 2019-02-27 16:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goodthroughdate', models.DateTimeField(blank=True, null=True)),
                ('documentid', models.ForeignKey(db_column='documentid', db_constraint=False, null=True,
                                                 on_delete=django.db.models.deletion.SET_NULL, to='datasets.AcrisRealMaster')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', django.contrib.postgres.search.SearchVectorField(blank=True, null=True)),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dobrundate', models.DateTimeField(blank=True, db_index=True, null=True)),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('streetname', models.TextField(blank=True, null=True)),
                ('worktype', models.TextField(blank=True, db_index=True, null=True)),
                ('jobdescription', models.TextField(blank=True, null=True)),
                ('issuedate', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('expirationdate', models.DateTimeField(blank=True, db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('residentialcommercialind', models.TextField(blank=True, db_index=True, null=True)),
                ('schedulestatus', models.TextField(blank=True, db_index=True, null=True)),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complaintid', models.ForeignKey(db_column='complaintid', db_constraint=False,
                                                  null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.HPDComplaint')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inspectiondate', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('approveddate', models.DateTimeField(blank=True, db_index=True, null=True)),
                ...
                ('currentstatusid', models.IntegerField(blank=True, db_index=True, null=True)),
                ('currentstatus', models.TextField(blank=True, db_index=True, null=True)),
        ...
        migrations.CreateModel(
            name='LisPendenComment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datecomments', models.TextField(blank=True, null=True)),
                ('key', models.ForeignKey(db_column='key', db_constraint=False, null=True,
                                          on_delete=django.db.models.deletion.SET_NULL, to='datasets.LisPenden')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.TextField(blank=True, null=True)),
                ('lot', models.TextField(blank=True, null=True)),
                ('cd', models.SmallIntegerField(blank=True, db_index=True, null=True)),
                ...
                ('zipcode', models.TextField(blank=True, db_index=True, null=True)),
                ...
                ('unitsres', models.IntegerField(blank=True, db_index=True, null=True)),
                ('unitstotal', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('council', models.ForeignKey(db_column='council', db_constraint=False,
                                              null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.Council')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bbl', models.ForeignKey(blank=True, db_column='bbl', db_constraint=False,
                                          null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.Property')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('borough', models.TextField(blank=True, null=True)),
                ('uc2007', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2008', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2009', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2010', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2011', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2012', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2013', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2014', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2015', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2016', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2017', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2018', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2019', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2020', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2021', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2022', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2023', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('uc2024', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=16, max_digits=32, null=True)),
                ('ucbbl', models.OneToOneField(blank=True, db_column='ucbbl', db_constraint=False,
                                               null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.Property')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yearbuilt', models.SmallIntegerField(blank=True, db_index=True, null=True)),
                ('bbl', models.ForeignKey(db_column='bbl', db_constraint=False, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bbbl', models.ForeignKey(db_column='bbbl', db_constraint=False, null=True,
                                           on_delete=django.db.models.deletion.SET_NULL, to='datasets.Property')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.AddField(
            ...
            name='bbl',
            field=models.ForeignKey(db_column='bbl', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.Property'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='hpdviolation',
            name='bin',
            field=models.ForeignKey(blank=True, db_column='bin', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.Building'),
        ),
        migrations.AddField(
            model_name='hpdviolation',
            name='buildingid',
            field=models.ForeignKey(blank=True, db_column='buildingid', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.HPDBuildingRecord'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='registrationid',
            field=models.ForeignKey(db_column='registrationid', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.HPDRegistration'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='isndobbisextract', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.DOBViolation'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='addressrecord',
            name='bin',
            field=models.ForeignKey(db_column='bin', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.Building'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='acrisreallegal',
            name='documentid',
            field=models.ForeignKey(blank=True, db_column='documentid', db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='datasets.AcrisRealMaster'),
        ),
        migrations.AddIndex(
            model_name='addressrecord',

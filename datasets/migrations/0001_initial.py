# Generated by Django 2.1 on 2018-12-29 02:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Council',
            fields=[
                ('district_number', models.IntegerField(primary_key=True, serialize=False)),
                ('shape_area', models.DecimalField(blank=True, decimal_places=10, max_digits=24, null=True)),
                ('shape_length', models.DecimalField(blank=True, decimal_places=10, max_digits=24, null=True)),

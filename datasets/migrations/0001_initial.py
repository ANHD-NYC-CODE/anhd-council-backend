# Generated by Django 2.1 on 2019-01-09 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=16, max_digits=32, null=True)),
                ('ucbbl', models.ForeignKey(db_column='ucbbl', db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.Property', unique=True)),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.AddField(

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complaintid', models.ForeignKey(db_column='complaintid', db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.HPDComplaint')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.ForeignKey(db_column='key', db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.LisPenden')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=16, max_digits=32, null=True)),
                ('ucbbl', models.OneToOneField(blank=True, db_column='ucbbl', db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.Property')),
            ],
            bases=(datasets.utils.BaseDatasetModel.BaseDatasetModel, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='acrisreallegal',
            name='documentid',
            field=models.ForeignKey(blank=True, db_column='documentid', db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='datasets.AcrisRealMaster'),
        ),
        migrations.AddIndex(
            model_name='addressrecord',

...
**What changed**
- Added DRF throttling in production only: 360 requests/minute for anonymous users, 600/minute for authenticated users.
...
**Failure modes**
- Legitimate power users hitting 360/min as anonymous will get HTTP 429. Log in for 600/min.
